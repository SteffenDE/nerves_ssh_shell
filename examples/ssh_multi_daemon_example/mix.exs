defmodule SSHMultiDaemonExample.MixProject do
  use Mix.Project

  @app :ssh_multi_daemon_example
  @version "0.1.0"
  ...
  def application do
    [
      mod: {SSHMultiDaemonExample.Application, []},
  ...
  defp deps do
    [
      ...
      {:nerves_ssh_shell, path: "../../"},
      {:nerves_runtime, "~> 0.11.6", targets: @all_targets, override: true},
